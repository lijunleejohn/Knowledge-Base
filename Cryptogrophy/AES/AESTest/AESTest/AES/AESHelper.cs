...
namespace AESTest.AES
{
    public static class AESHelper
    {
        ...
        {
            byte[] encrypted = AESCore.EncryptByte2Byte(Encoding.UTF8.GetBytes(originalString), key, iv);
        ...
        {
            byte[] encrypted = AESCore.EncryptByte2Byte(originalImage, key, iv);
            return Convert.ToBase64String(encrypted);
        }
        ...
        {
            byte[] decrypted = AESCore.DecryptByte2Byte(Convert.FromBase64String(cryptedString), dKey, dIv);
