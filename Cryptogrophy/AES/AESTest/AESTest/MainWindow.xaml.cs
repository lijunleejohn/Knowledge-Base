...
namespace DesTest
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private static string keyValue = "lH&^f%4D$#saS#)A";
        private static string initialVector = "OneCloud^7$3(K)?";
        ...
        {
            txtDesEncoded.Text = AESHelper.EncryptString2String(txtOriginal.Text, key, iv);
        }
        ...
        private void btnTextDesDecode_Click(object sender, RoutedEventArgs e)
        {
            ...
            txtDesDecode.Text = AESHelper.DecryptString2String(txtDesEncoded.Text, dKey, dIv);
        }
        ...
        private void btnImageDesEncode_Click(object sender, RoutedEventArgs e)
        {
            ...
            txtImageDesEncode.Text = AESHelper.EncryptByte2String(imageBytes, key, iv);

            //write byte array into a file
            File.WriteAllBytes(imageFileName, AESCore.EncryptByte2Byte(imageBytes, key, iv));
        }
        ...
        private void btnImageDesDecode_Click(object sender, RoutedEventArgs e)
        {
            dKey = ASCIIEncoding.ASCII.GetBytes(txtKey.Text);
            dIv = ASCIIEncoding.ASCII.GetBytes(txtIv.Text);
            byte[] imageBytes = AESHelper.DecryptString2Byte(txtImageDesEncode.Text, dKey, dIv);    //Decode uses self wrote Base64Algorithm.Base64Decode()
        ...
        private void btnLoadDesBinFile_Click(object sender, RoutedEventArgs e)
        {
            dKey = ASCIIEncoding.ASCII.GetBytes(txtKey.Text);
            dIv = ASCIIEncoding.ASCII.GetBytes(txtIv.Text);
            byte[] imageBytes = AESCore.DecryptByte2Byte(File.ReadAllBytes(imageFileName), dKey, dIv);    //Decode uses self wrote Base64Algorithm.Base64Decode()
